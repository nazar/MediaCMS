...
class WorldPayHelperTest < Test::Unit::TestCase
  ...
  def test_valid_from_time
    ...
    @helper.valid_from Time.parse('2007-01-01 00:00:00')
    assert_field 'authValidFrom', '1167606000000'
    
  end
  
  def test_valid_to_time
  
    @helper.valid_to Time.parse('2007-01-01 00:00:00')
    assert_field 'authValidTo', '1167606000000'
