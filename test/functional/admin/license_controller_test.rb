...
require 'admin/license_controller'

# Re-raise errors caught by the controller.
class Admin::LicenseController; def rescue_action(e) raise e end; end

class Admin::LicenseControllerTest < Test::Unit::TestCase
  fixtures :licenses

  def setup
    @controller = Admin::LicenseController.new
